...
from model_config import CNN_Config
...
space = {
    ...
    # Number of EPOCHS
    'epochs': hp.quniform('epochs', 10, 80, 10),
    # Choice of optimizer:
    ...
    'first_conv': hp.choice(
        'first_conv', [None, hp.choice('first_conv_size', [3, 5, 7])]
    ),
    ...
    'nb_conv_pool_layers': hp.choice('nb_conv_pool_layers', [2, 3, 4, 5, 6, 7, 8, 9]),
...
utils = {
    'tensorboard_dir': "TensorBoard/RT_50",
    'nb_channels': 3,
    'nb_classes': 3,
    'image_border_length': 128,
    'train_dir': "data/topomaps_RT_50_w_sub/train/combined/",
    'test_dir': "data/topomaps_RT_50_w_sub/test/combined/",
    'results_dir': "results/RT_50/",
    'hyperspace': space

}

cnn_config = CNN_Config(utils)
...
def run_a_trial():
    ...
    try:
        ...
        trials = pickle.load(open("results_RT_50.pkl", "rb"))
    ...
    pickle.dump(trials, open("results_RT_50.pkl", "wb"))
